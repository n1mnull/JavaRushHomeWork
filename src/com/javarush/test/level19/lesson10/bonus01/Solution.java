...
public class Solution
{
    ...
    public static void main(String[] args) throws IOException
    {
        ...
        BufferedReader file1Reader = new BufferedReader(new FileReader(bufferedReader.readLine()));
        BufferedReader file2Reader = new BufferedReader(new FileReader(bufferedReader.readLine()));
