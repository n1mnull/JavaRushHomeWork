...
public class Solution {
    ...
    static {
//        firstFileName = "Y:\\a.txt";
//        secondFileName = "Y:\\b.txt";
    ...
    public static class ReadFileThread extends Thread implements ReadFileInterface{
        ...
        {
            try {
                BufferedReader bufferedFileReader = new BufferedReader(new FileReader(fullFileName));
                String tempStr;
                while ((tempStr=bufferedFileReader.readLine()) != null ) {
