...
public class Solution
{
    public static void main(String[] args) throws Exception
    {
        ...
        int count=0;
        while (true) { //ввести с консоли несколько ключей (строк), пункт 7
            movieCurrent = movieReader.readLine();
            if (movieCurrent.equals("soapOpera")||movieCurrent.equals("cartoon")||movieCurrent.equals("thriller")){
                movieList[count] = movieCurrent;
                count++;
            } else {
                break;
            }
        ...
        */
        ...
        {
            movie[i] = MovieFactory.getMovie(movieList[i]);
            System.out.println(movie[i].getClass().getSimpleName());
        }
    }
